  ...
  const transcriptSeeds = [
    {
      ...
      title: "Discovery Call with Oliver Laurent — MedVista Claude Enterprise",
      date: daysAgo(5),
      durationSeconds: 32 * 60,
      participants: [
        { name: "Sarah Chen", role: "AE" },
        { name: "Oliver Laurent", role: "VP of Engineering" },
      ],
      summary: "Discovery call covering MedVista's clinical documentation workflow. Oliver (VP Engineering) described 2+ hours daily spent on manual documentation across 200 clinicians. Key pain points: compliance burden (HIPAA, SOC 2), data residency requirements for EU operations, and upcoming board presentation in August requiring a POC by July. Microsoft Copilot was previously evaluated but had data privacy concerns. Budget authority likely with CFO Emma Mueller, not yet engaged.",
      painPoints: [
        "2+ hours daily spent on manual clinical documentation across 200 clinicians",
        "HIPAA and SOC 2 compliance burden on documentation workflows",
        "EU data residency requirements for clinical data",
        "Board presentation deadline in August requires POC by July",
      ],
      nextSteps: [
        "Send HIPAA Compliance FAQ and SOC 2 certification summary",
        "Schedule technical deep-dive with Oliver's architecture team",
        "Prepare ROI calculation based on 200 clinicians × 2hrs/day",
        "Identify path to engage CFO Emma Mueller",
      ],
      stakeholders: [
        { name: "Oliver Laurent", title: "VP of Engineering", sentiment: "positive" },
        { name: "Emma Mueller", title: "CFO", sentiment: "unknown" },
      ],
      budgetSignals: [
        "€850K annual cost of manual documentation mentioned",
        "Board approval required — August deadline",
      ],
      competitiveMentions: [
        "Microsoft Copilot evaluated but rejected for data privacy concerns",
      ],
      talkRatio: { ae: 35, prospect: 65 },
      callQualityScore: 78,
      meddpicc: {
        metrics: "200 clinicians, €850K annual documentation cost, 2+ hrs/day per clinician",
        economic_buyer: "Emma Mueller (CFO) — NOT yet engaged",
        decision_criteria: "Data privacy, HIPAA compliance, EU data residency",
        decision_process: "Board approval required, August presentation deadline, POC by July",
        champion: "Oliver Laurent — willing but unclear if actively selling internally",
      },
      coaching: [
        "Strong discovery — let the prospect talk 65% of the time",
        "Quantified pain early (€850K) — excellent anchor for ROI discussions",
        "Gap: CFO not yet engaged. Prioritize multi-threading to economic buyer.",
        "Consider asking Oliver to champion an internal brief for Emma",
      ],
    },
    {
