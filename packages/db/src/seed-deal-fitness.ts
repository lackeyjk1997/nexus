...
async function seedDealFitness() {
  ...
  // ══════════════════════════════════════════════════════
  // Deal Fitness — no pre-seeded outputs
  // Events + scores are generated by the pipeline when transcripts are processed
  // ══════════════════════════════════════════════════════
  // Wipe any leftover fitness data so demo starts clean
  await db
  ...
  console.log("  ✓ Cleared any leftover fitness data");

  // (Fitness events and scores are no longer seeded — they are generated
  //  incrementally by the pipeline as each transcript is processed)
  ...
  console.log("   Fitness data: none (generated by pipeline)");
...
/* --- removed: fitness event + score inserts (now generated by pipeline) ---
